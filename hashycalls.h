...
#define HASH_SEED 7904
#define KERNEL32 0x79FE6552
#define NTDLL 0x28DB7934
#define KERNELBASE 0x7755EDC4
#define WINDIR 0xC7ACD551
#define SYSTEM32 0x8422B06E
#define LoadLibraryA_Hash 0xC9AB3ACC
#define FindFirstFileA_Hash 0xCD648F4E
#define FindNextFileA_Hash 0xD2E3A399

#define VirtualAlloc_Hash 0x2451252A
#define CreateRemoteThread_Hash 0x97F9F10C
#define WriteProcessMemory_Hash 0x2787EC51
#define WaitForSingleObject_Hash 0x42C59E3B
...
API_CALL_LIST HashedAPI = {
	.VirtualAlloc.Hash = 0x2451252A,
	.VirtualAlloc.ModuleHash = 0x79FE6552,
	.CreateRemoteThread.Hash = 0x97F9F10C,
	.CreateRemoteThread.ModuleHash = 0x79FE6552,
	.WriteProcessMemory.Hash = 0x2787EC51,
	.WriteProcessMemory.ModuleHash = 0x79FE6552,
	.WaitForSingleObject.Hash = 0x42C59E3B,
	.WaitForSingleObject.ModuleHash = 0x79FE6552,
};
